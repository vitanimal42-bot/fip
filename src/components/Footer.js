...
export default function Footer({ dict, lang = 'tr', socialLinks = {} }) {
  const links = socialLinks[lang] || socialLinks['tr'] || {};
  const navLinks = [
    ...
    { label: dict.nav.forms, href: `/${lang}/bilgi-formlari` },
      ...
      <div className="container footer__grid">
        ...
        <div className="stack">
          ...
          <div className="social-icons" style={{ display: "flex", gap: "12px", marginTop: "8px" }}>
            {links.instagram && (
              <a href={links.instagram} target="_blank" rel="noopener noreferrer" aria-label="Instagram" style={{ color: "rgba(255,255,255,0.8)" }}>
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"></line></svg>
              </a>
            )}
            {links.youtube && (
              <a href={links.youtube} target="_blank" rel="noopener noreferrer" aria-label="YouTube" style={{ color: "rgba(255,255,255,0.8)" }}>
            ...
            {links.twitter && (
              <a href={links.twitter} target="_blank" rel="noopener noreferrer" aria-label="X (Twitter)" style={{ color: "rgba(255,255,255,0.8)" }}>
            ...
            {links.facebook && (
              <a href={links.facebook} target="_blank" rel="noopener noreferrer" aria-label="Facebook" style={{ color: "rgba(255,255,255,0.8)" }}>
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"></path></svg>
              </a>
            )}
            {links.pinterest && (
              <a href={links.pinterest} target="_blank" rel="noopener noreferrer" aria-label="Pinterest" style={{ color: "rgba(255,255,255,0.8)" }}>
            ...
            {links.whatsapp && (
              <a href={links.whatsapp} target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" style={{ color: "rgba(255,255,255,0.8)" }}>
