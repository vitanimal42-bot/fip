  ...
  return (
    <div className="about-page">
      ...
      <section style={{
        ...
        padding: '160px 0 100px', // More padding to clear fixed header and give breathing room
        textAlign: 'center',
        backgroundImage: 'url(/soft-bg.png)',
        backgroundSize: 'cover',
        borderBottom: '1px solid rgba(0,0,0,0.05)'
      }}>
        <div className="container">
          <h1 className="headline headline--lg" style={{ color: 'var(--brand-deep)', margin: 0 }}>
            {(page.eyebrow || page.title).toLocaleUpperCase(lang === 'tr' ? 'tr-TR' : lang)}
          </h1>
        </div>
      </section>

      <div className="section" style={{ background: 'white', padding: '100px 0' }}>
